/*
 * @Description: 线形进度条
 * @Date: 2021-07-07 17:34:07
 * @LastEditTime: 2021-07-08 17:52:06
 */
...
function ProgressBar(props){
  ...
  const progressClick = (e) =>{
    //getBoundingClientRect()获取某个元素相对于视窗的位置集合(top,right,left,bottom等)
    const react = progressBar.current.getBoundingClientRect();
